...
const Social = () => {
  ...
  <div className='flex items-center justify-between px-6 py-2 m-8 mt-4 md:justify-evenly md:m-28 rounded-3xl bg-gradient-to-r from-fuchsia-700 to-indigo-500 hover:from-indigo-500 hover:to-fuchsia-500 font-[Abel] min-w-lg'>
    ...
    <h3 className="mt-3 font-extrabold tracking-widest text-black text-md nav-links">SoundCloud</h3>
    </div>
  ...
  <h3 className="mt-3 font-extrabold tracking-widest text-black text-md nav-links ">MixCloud</h3>
    </div>
  ...
  <h3 className="mt-3 font-extrabold tracking-widest text-black text-md nav-links">Instagram</h3>
    </div>
  </div>
  );
}
